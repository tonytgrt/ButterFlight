...
% Figures live in ../Design_Doc/img/  — keep the design-doc relative
% paths working.
...
% Document the workflow of the authoring tool — describe how a
% user would use the tool from start to finish.
% ------------------------------------------------------------

% TODO: workflow walkthrough (load plugin, source MEL, open UI,
% pick rig, choose mode, set parameters, simulate, scrub).


% ------------------------------------------------------------
\subsection{Content Creation}
% Screenshots with descriptions showing UI, workflow, and typical
% output of the authoring tool.
% ------------------------------------------------------------

% TODO: UI panel screenshots; before/after viewport; final scene
% renders; per-mode example outputs.
