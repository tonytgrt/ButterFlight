...
% TODO: enumerate shipped features.

\subsubsection{What Worked}
% TODO: which design choices held up; what was easier than expected.

\subsubsection{What Did Not Work}
% TODO: things attempted that had to be redesigned or dropped.

\subsubsection{Features Not Implemented}
% TODO: features in the Design Doc that didn't ship — and why.
...
% TODO: each notable deviation, with cause and consequence.
...
% TODO: per-member total hours, sourced from weekly progress reports.
...
% TODO: feature gaps, polish, performance, robustness.
...
% TODO: Maya APIs, libraries, Chen et al. 2022 paper, FBX/Alembic
% exporters, XGen, Arnold/Renderer, asset packs, etc.
...
% Describe how AI was used in preparing the Literature Survey
% (finding relevant references, summarizing previous works, etc.).
% What tools and software were used?
% TODO

\subsubsection{Design Doc}
% Describe how AI was used in preparing the Design Doc (software
% design details, work plan task decomposition; enhancing,
% editing, or revising what was written).  What tools were used?
% TODO

\subsubsection{Authoring Tool Software Development}
% Describe how AI was used to develop the authoring tool itself
% (Maya APIs, classes/functions; C++ class descriptions; code
% generation; UI design and implementation, etc.).  What tools
% were used?
% TODO
