...
\begin{figure}[H]
  ...
  \caption{ButterFlight panel after launch, with the rig root assigned in
    Section~1 and Hover selected as the simulation mode.}
...
% TODO: enumerate lessons (per Maya quirks, MEL gotchas, build
% setup, animation curve handling, joint orient pitfalls, etc.).
